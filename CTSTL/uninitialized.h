#ifndef CTSTL_UNINITIALIZED_H_
#define CTSTL_UNINITIALIZED_H_
...
{
    return ctstl::copy(first, last, result);
}
...
ForwardIter
uninitialized_copy_n(InputIter first, Size n, ForwardIter result, std::true_type)
{
    return ctstl::copy_n(first, n, result).second;
}

template <class InputIter, class Size, class ForwardIter>
ForwardIter
uninitialized_copy_n(InputIter first, Size n, ForwardIter result, std::false_type)
{
    auto cur = result;
    try
    {
...
{
    return ctstl::fill_n(first, n, value);
}
...
{
    return ctstl::unchecked_uninit_fill_n(first, n, vlaue,
                                          std::is_trivially_copy_assignable<
                                          typename iterator_traits<ForwardIter>::
                                          value_type>{});
}
